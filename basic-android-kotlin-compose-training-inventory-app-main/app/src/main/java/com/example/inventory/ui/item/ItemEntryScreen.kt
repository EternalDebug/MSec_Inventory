...
fun ItemEntryScreen(
    ...
    Scaffold(
        ...
        val launcher = rememberLauncherForActivityResult(ActivityResultContracts.GetContent()) { selectedUri ->
            if (selectedUri != null) {
                viewModel.DownloadFromEncryptedFile(selectedUri)
                navigateBack()
            }
        }
        ItemEntryBody(
...
fun ItemInputForm(
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            label = { Text(stringResource(R.string.item_agname_req)) },
            colors = OutlinedTextFieldDefaults.colors(
                focusedContainerColor = MaterialTheme.colorScheme.secondaryContainer,
                unfocusedContainerColor = MaterialTheme.colorScheme.secondaryContainer,
                disabledContainerColor = MaterialTheme.colorScheme.secondaryContainer,
        ...
        OutlinedTextField(
            ...
            onValueChange = { onValueChange(itemDetails.copy(agentMail = it)) },
            label = { Text(stringResource(R.string.item_agmail_req)) },
            colors = OutlinedTextFieldDefaults.colors(
                focusedContainerColor = MaterialTheme.colorScheme.secondaryContainer,
                unfocusedContainerColor = MaterialTheme.colorScheme.secondaryContainer,
                disabledContainerColor = MaterialTheme.colorScheme.secondaryContainer,
        ...
        OutlinedTextField(
            value = itemDetails.agentPhone,
            onValueChange = { onValueChange(itemDetails.copy(agentPhone = it)) },
            label = { Text(stringResource(R.string.item_agphone_req)) },
            colors = OutlinedTextFieldDefaults.colors(
                focusedContainerColor = MaterialTheme.colorScheme.secondaryContainer,
                unfocusedContainerColor = MaterialTheme.colorScheme.secondaryContainer,
                disabledContainerColor = MaterialTheme.colorScheme.secondaryContainer,
...
private fun ItemEntryScreenPreview() {
    InventoryTheme {
        ...
        ), onItemValueChange = {}, onSaveClick = {}, onDownloadClick = {})
    }
}
